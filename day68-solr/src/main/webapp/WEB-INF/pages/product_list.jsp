...
<script type="text/javascript">
	...
	function changePage(p) {
		...
		if (curpage + p > ${result.totalPage}){
		    curpage = 1;
		} else if (curpage + p < 1) {
		    curpage = ${result.totalPage};
		} else {
            curpage = curpage + p;
		}
